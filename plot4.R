...
##plot1
plot(dataset$datatime, dataset$Global_active_power, xlab="", ylab="Global active power", type="l")
...
#plot3
plot(dataset$datatime, dataset$Voltage, xlab="DateTime", ylab="Voltage", type="l")

#plot4
plot(dataset$datatime, dataset$Global_reactive_power, xlab="DateTime", ylab="Global reactive power", type="l")
